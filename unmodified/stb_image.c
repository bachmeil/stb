...
extern void setbuf (FILE *restrict __stream, char *restrict __buf) __attribute__ ((__nothrow__ , __leaf__));
...
extern int sprintf (char *restrict __s,
      const char *restrict __format, ...) __attribute__ ((__nothrow__));
...
extern int sscanf (const char *restrict __s,
     const char *restrict __format, ...) __attribute__ ((__nothrow__ , __leaf__));
...
extern int sscanf (const char *restrict __s, const char *restrict __format, ...) asm ("" "__isoc99_sscanf") __attribute__ ((__nothrow__ , __leaf__));
...
extern int vfscanf (FILE *restrict __s, const char *restrict __format, __gnuc_va_list __arg) asm ("" "__isoc99_vfscanf")
     __attribute__ ((__format__ (__scanf__, 2, 0))) ;
extern int vscanf (const char *restrict __format, __gnuc_va_list __arg) asm ("" "__isoc99_vscanf")
     __attribute__ ((__format__ (__scanf__, 1, 0))) ;
extern int vsscanf (const char *restrict __s, const char *restrict __format, __gnuc_va_list __arg) asm ("" "__isoc99_vsscanf") __attribute__ ((__nothrow__ , __leaf__))
     __attribute__ ((__format__ (__scanf__, 2, 0)));
